<div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 mb-6 flex flex-col md:flex-row gap-4">
        ...
        <div class="w-full md:w-64">
            <select wire:model.live="filterStatus" class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors min-h-[44px]">
        ...
        <div class="flex-1 relative">
            ...
            <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari no. pesanan atau nama pelanggan..." class="block w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors min-h-[44px]">
        </div>
    </div>
